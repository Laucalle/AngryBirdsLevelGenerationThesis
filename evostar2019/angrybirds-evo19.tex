...
For the purpose of this paper, we take the definition of Procedural Game Generation
...
generated will be much more engaging.
...
\begin{figure}
	\centering
	\includegraphics[scale=0.3]{level-0-180523_203106.png}
	\caption{One of the results for \ref{E1}: Fitness = 9.021, nBlocks = 7, G = 100  }\label{f:e1}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.3]{level-0-base_large180529_223045.png}
	\caption{One of the solutions from \ref{E2}: Fitness = 5.176, nBlocks = 9, G = 767  }\label{f:e2-4}
\end{figure}
...
results. However, executions took longer on average(table \ref{t:resOver}), which makes sense given 
...
\begin{figure}
	\centering
	\includegraphics[scale=0.3]{level-0-second_crossover180613_055622.png}
	\caption{One of the solutions from \ref{E3}: Fitness = 1.571e-7, nBlocks = 9, G = 194  }\label{f:e3-4}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.3]{level-0-second_crossover_min10_180602_035405.png}
	\caption{One of the solutions from \ref{E4}: Fitness = 9.229e-7, nBlocks = 10, G = 198 }\label{f:e4-1}
\end{figure}
...
from those experiments, it does not make sense to compare their fitness value.
 \begin{figure}
 	\centering
 	\includegraphics[scale=0.4]{E5.png}
...
Again, with a different fitness function we cannot compare the fitness value with the rest of the experiments.
 \begin{figure}
 	\centering
 	\includegraphics[scale=0.4]{E6.png}
