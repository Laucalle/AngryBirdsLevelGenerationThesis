...
% Antonio - this is not needed to mention in a conference about research in videogames. ;)
...
The ultimate objective of this work is to build a program capable of 
creating levels for \textit{Angry Birds}. This by itself is too vague to convey 
the desired approach for the paper, so we can break it down to the following, 
