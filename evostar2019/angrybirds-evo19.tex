...
agents and discarded if they are unable to 
solve it. The lowest number of birds used by the agents 
...
levels. Their game clone will be used in this paper. % Same game clone as we 
%use here? - JJ
% yes - Laura
...
inside a column. This implies that a shape is chosen
