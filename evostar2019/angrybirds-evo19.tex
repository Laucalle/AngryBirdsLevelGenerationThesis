...
Thus, the main contributions related with this paper objectives are entries presented to previous editions of the Angry Birds Level Generation Competition. 
...
% Antonio - TODO (for me): revise and improve this. Add new references to other related works.
...
generated, but still precludes the formation of disjoint structures
...
% inaccurate.
So, a punishment is applied and the level is not simulated either. 
...
\begin{table}[H]
	...
	\begin{tabular}{ccccc}
		...
		\textbf{Time (h)} & 0.89 $\pm$ STDDEV & 1.002 & 1.76 & 5.03 \\  \hline
...
\end{itemize}
% Antonio - I agree, you could save space using a table with two columns, for instance. Moreover it will be easier for the reader to find the configuration in a table. ;)
