...
%\titlerunning{Generation of Angry Birds Levels}
...
%
 ...
 \author{Laura Calle \inst{1}
   \and
   Juan J. Merelo\inst{1}
 \and
 Antonio Mora-García\inst{1}
 \and
 José-Mario García-Valdez\inst{3}
}

\authorrunning{Calle et al.}

 \institute{%
   Universidad de Granada/CITIC\\
   Granada, Spain\\
   \email{laucalle09@gmail.com,\{jmerelo,amorag\}@ugr.es}\\
 \and
...
soundness. % TODO Change this sentence 
...
frameworks such as DEAP \cite{fortin2012deap}, PyEvolve \cite{perone2009pyevolve} or Evolopy \cite{evolopy}
and therefore a new framework was created. The source  code can be found on GitHub \cite{ab-level-nonanon}.
