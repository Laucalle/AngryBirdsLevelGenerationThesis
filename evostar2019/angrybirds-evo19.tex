...
This project was developed with a set of objectives in mind: The first
...
will lead to unexpected and even disappointing outcomes. 
...
considered half a victory. % Not enough for a paper. Let's say 75% - JJ
The levels generated in the last two experiments were 
undeniably stable. Whether or not they can be considered structures, that is 
arguable. % if the 4th experiment does not find any kind of structure,
          % we should modify title and abstract to talk about "proof
          % of concept" or "First steps" - JJ
Again, the main issue is how we evaluate the levels. In fact this is 
