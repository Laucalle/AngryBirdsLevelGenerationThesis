...
PCG is becoming more frequently used in new games as one of the main tools for supporting designers and developers.
...
Some birds are more efficient against certain materials than others, so those  
used in the level are determined by the material. The number 
of birds available is estimated using AI 
...
species using L�vy flight behaviour, a random walk that follows a certain 
...
the ground and do not have more than a few floors. % Tell me what you
								% think of this. 
								% Floors is not exact. ..more than a few stacked blocks? - Mario 
