...
\IEEEauthorblockA{\textit{Universidad de M�laga} \\
M�laga, Spain\\
...
jmerelo@ugr.es}
\and
\IEEEauthorblockN{Mario Garc�a Valdez}
\IEEEauthorblockA{\textit{Instituto Tecnol�gico de Tijuana} \\
Tijuana, Mexico\\
mario@tectijuana.edu.mx}
\and
\IEEEauthorblockN{Antonio Mora Garc�a}
\IEEEauthorblockA{\textit{Universidad de Granada} \\
Granada, Spain\\
amorag@ugr.es}
}
...
version is available on GitHub \url{https://github.com/Laucalle/AngryBirdsLevelGenerationThesis}. It produces output 
...
In later experiments we will use Box2D (\url{https://box2d.org}), a physics engine written in C++ originally
...
The parameters are in table \ref{t:base}: % A table is better for this - JJ
