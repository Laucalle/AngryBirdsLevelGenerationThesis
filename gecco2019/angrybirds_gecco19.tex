...
\begin{document}
\title{Improved Free Form Evolution for Angry Birds Level Generation}
...
\affiliation{%
  \institution{Institute anonymous 1}
  \streetaddress{Street 1}
  \city{City 1} 
  \state{State 1} 
  \postcode{Postcode 1}
}
\email{author1@dom.com}
...
\affiliation{%
  ...
  \city{City 3} 
  \country{Country 3}}
\email{author3@dom.org}

\author{Author 4}
\affiliation{%
  \institution{Institute 4}
  \city{City 4}
  \country{Country 4}
}
%\author{Aparna Patel} 
...
Angry Birds levels with the minimum number of constraints. This approach consists of a search-based procedural level 
...
\begin{figure}
	\centering
	\includegraphics[scale=0.25]{level-0-180523_203106.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.25]{level-0-base_large180529_223045.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.25]{level-0-second_crossover180613_055622.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.25]{level-0-second_crossover_min10_180602_035405.png}
...
% Antonio - The bibliography style gives an error I don't know how to solve
